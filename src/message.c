...
_v3_msg_alloc(v3_handle v3h, uint32_t type, size_t len, void **contents) {
    ...
    _v3_debug(v3h, V3_DBG_MEMORY, "allocating message: %u bytes", sizeof(*m));
    m = calloc(1, sizeof(*m));
...
_v3_msg_handshake_put(v3_handle v3h) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_HANDSHAKE, sizeof(*mc), (void **)&mc);
...
_v3_msg_move_put(v3_handle v3h, uint16_t id, uint16_t channel) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_MOVE, sizeof(*mc), (void **)&mc);
...
_v3_msg_chat_put(v3_handle v3h, uint16_t subtype, const char *message) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_CHAT, sizeof(*mc), (void **)&mc);
...
_v3_msg_user_option_put(v3_handle v3h, uint16_t user, uint16_t subtype, uint32_t value) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_USER_OPTION, sizeof(*mc), (void **)&mc);
...
_v3_msg_login_put(v3_handle v3h) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_LOGIN, sizeof(*mc), (void **)&mc);
...
_v3_msg_chan_list_put(v3_handle v3h, uint16_t subtype, uint16_t user, const char *password, const v3_channel *c) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_CHAN_LIST, sizeof(*mc), (void **)&mc);
...
_v3_msg_timestamp_put(v3_handle v3h) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_TIMESTAMP, sizeof(*mc), (void **)&mc);
...
_v3_msg_audio_put(v3_handle v3h, uint16_t subtype, int16_t index, int16_t format, uint32_t pcmlen, const void *data, uint32_t datalen) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_AUDIO, sizeof(*mc), (void **)&mc);
...
_v3_msg_phantom_put(v3_handle v3h, uint16_t subtype, uint16_t phantom, uint16_t channel) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_PHANTOM, sizeof(*mc), (void **)&mc);
...
_v3_msg_hash_table_put(v3_handle v3h, uint16_t subtype) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_HASH_TABLE, sizeof(*mc), (void **)&mc);
...
_v3_msg_user_list_put(v3_handle v3h, uint16_t subtype, const v3_user *u) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_USER_LIST, sizeof(*mc), (void **)&mc);
...
_v3_msg_user_page_put(v3_handle v3h, uint16_t to, uint16_t from) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_USER_PAGE, sizeof(*mc), (void **)&mc);
...
_v3_msg_admin_put(v3_handle v3h, uint16_t subtype, uint16_t user, const void *data) {
    ...
    m = _v3_msg_alloc(v3h, V3_MSG_ADMIN, sizeof(*mc), (void **)&mc);
      ...
      case V3_MSG_AUTH:
        {
            ...
            switch (mc->subtype) {
              ...
              case V3_AUTH_ADMIN:
                ...
                break;
              case V3_AUTH_KEYS:
                v3c->client_key = calloc(1, sizeof(*v3c->client_key));
                v3c->server_key = calloc(1, sizeof(*v3c->server_key));
                if (_v3_read_keys(
                        v3h,
                        v3c->client_key,
                        v3c->server_key,
                        m->data + sizeof(*mc),
                        m->len - sizeof(*mc)) != V3_OK) {
      ...
      case V3_MSG_RANK_LIST:
        {
            ...
            for (ptr = m->data + sizeof(*mc), ctr = 0; ctr < mc->count; ++ctr) {
                memset(&r, 0, sizeof(r));
            ...
            if (_v3_data(v3h, V3_DATA_RETURN, V3_DATA_TYPE_USER, &u, 0) == V3_OK) {
                ...
                switch (mc->subtype) {
                  ...
                  case V3_CHAT_RCON:
                    ...
                    _v3_msg_string_get(v3h, m->data + sizeof(*mc), ev.data.message, sizeof(ev.data.message) - 1);
      ...
      case V3_MSG_CHAN_LIST:
        {
            ...
            _v3_msg_channel_get(v3h, m->data + sizeof(*mc), &c);
              ...
              case V3_PROP_CLIENT:
                ...
                if (mc->subtype != V3_PROP_SEND) {
                    if (!mc->ignore) {
                        ...
                        _v3_msg_string_get(v3h, m->data + sizeof(*mc), value, sizeof(value) - 1);
            ...
            if (_v3_data(v3h, V3_DATA_RETURN, V3_DATA_TYPE_USER, &u, 0) == V3_OK) {
                ...
                switch (mc->subtype) {
                  ...
                  case V3_AUDIO_DATA:
                    ...
                    ptr = _v3_msg_uint16_get(v3h, m->data + sizeof(*mc), NULL, 0, NULL);
